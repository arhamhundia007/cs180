...
public final class SearchView {
    ...
    public String toString() {
        return String.format("RemoveView[%s, %s, %s, %s, %s, %s\n\n]", this.mainPanel, this.fieldComboBox, this.searchValueTextField, this.resultsTextArea, this.searchButton, this.clearButton);
    } //toString
}